...
//                symbolSet.put(c, new Image(new FileInputStream("data/AlieneseTwo/num/" + c + ".png")));
//            }
//            for (NonStandardChar nsc : OTHER_CHARS) {
//                symbolSet.put(nsc.charRep(), new Image(new FileInputStream("data/AlieneseTwo/" + nsc.stringRep() + ".png")));
//            }
